...
from planning_utils import a_star, heuristic, create_grid, show_map, prune_path
...
class MotionPlanning(Drone):
    ...
    def plan_path(self):
        ...
        print('home_position: ', np.array([lon0, lat0, 0]))
        ...
        goal_global_position = (-122.3982, 37.7933, 0)
        ...
        # show map with start and goal positions
        show_map(grid, grid_start, grid_goal, path)
